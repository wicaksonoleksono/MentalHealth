...
class Assessment(db.Model):
    ...
    def complete_assessment_type(self, assessment_type):
        """Mark an assessment type as completed."""
    ...
    def get_completion_order(self):
        """Get the order in which assessments were completed."""
        return {
...
class EmotionData(db.Model):
    ...
    emotions_detected = db.Column(db.JSON)  # Store all detected emotions with scores
