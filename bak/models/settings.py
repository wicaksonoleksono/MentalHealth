...
class SettingsKey(Enum):
    ...
    SCALE_LABEL_2 = ('scale_label_2', 'string', 'Label skala untuk 2', 'Lebih dari separuh hari')
    SCALE_LABEL_3 = ('scale_label_3', 'string', 'Label skala untuk 3', 'Hampir setiap hari')
    SCALE_LABEL_4 = ('scale_label_4', 'string', 'Label skala untuk 4', 'Selalu')
    SCALE_LABEL_5 = ('scale_label_5', 'string', 'Label skala untuk 5', 'Sangat')
    SCALE_LABEL_6 = ('scale_label_6', 'string', 'Label skala untuk 6', 'Sangat tinggi')
    SCALE_LABEL_7 = ('scale_label_7', 'string', 'Label skala untuk 7', 'Maksimal')
    SCALE_LABEL_8 = ('scale_label_8', 'string', 'Label skala untuk 8', 'Parah')
    SCALE_LABEL_9 = ('scale_label_9', 'string', 'Label skala untuk 9', 'Kritis')
